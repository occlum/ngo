...
use self::impls::{Ipv4Datagram, Ipv4Stream, Ipv6Datagram, Ipv6Stream, UnixDatagram};
...
impl SocketFile {
    pub fn new(
        ...
        // if protocol != SocketProtocol::IPPROTO_IP && protocol != SocketProtocol::IPPROTO_TCP && protocol != SocketProtocol::IPPROTO_UDP {
